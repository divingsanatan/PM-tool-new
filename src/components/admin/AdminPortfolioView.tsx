        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap sm:flex-nowrap pt-1 sm:pt-0 shrink-0">
            ...
            <button
              ...
              className="flex-1 sm:flex-none px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/40 text-xs font-semibold flex items-center justify-center gap-1.5 sm:gap-2 transition-all"
            >
              <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-400" />
              <span className="whitespace-nowrap">AI Insights ({portfolioInsights.length})</span>
            </button>
          </div>
        </div>
