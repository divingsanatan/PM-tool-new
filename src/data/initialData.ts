...
export const initialProjectData: ProjectData = {
  ...
  projectManagerEmail: "alex.m@apex.io",
  projectManagerIds: ["user-pm-1"],
  projectManagerEmails: ["alex.m@apex.io"],
  stakeholders: [
    {
      id: "sh-admin",
    ...
    },
    {
      ...
      isDualPMDev: true, // Holds both Project Manager authority and developer task ownership
      category: "internal",
      avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=150",
      hourlyRate: 120,
      weeklyCapacityHours: 40,
      skills: ["Agile", "EVM", "Risk Management", "Full Stack Development"],
      status: "active"
    },
    {
      id: "sh-2",
    ...
    },
    {
      ...
      role: "Developer (Team member)",
      appRole: "Developer (Team member)",
      isDualPMDev: true, // Dual Developer & PM: has all PM access and has his own developer tasks
      hasPMAccess: true,
      category: "internal",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=150",
      hourlyRate: 110,
      weeklyCapacityHours: 40,
      skills: ["React", "TypeScript", "Node.js", "WebSockets", "Sprint Planning"],
      status: "active"
    },
    {
      id: "sh-4",
    ...
    },
    {
      ...
      hourlyRate: 85,
      weeklyCapacityHours: 40,
      skills: ["CI/CD", "Docker", "Kubernetes", "Automated Testing", "Cypress"],
      status: "active"
    }
  ],
  milestones: [
...
export const project2Data: ProjectData = {
  ...
  budget: 180000,
  projectManagerId: "user-pm-2",
  projectManagerEmail: "carlos.s@apex.io",
  projectManagerIds: ["user-pm-2"],
  projectManagerEmails: ["carlos.s@apex.io"],
...
export const project3Data: ProjectData = {
  ...
  budget: 320000,
  projectManagerId: "user-pm-3",
  projectManagerEmail: "aisha.m@apex.io",
  projectManagerIds: ["user-pm-3"],
  projectManagerEmails: ["aisha.m@apex.io"],
  stakeholders: [...initialProjectData.stakeholders],
  epics: [],
  features: [
    {
